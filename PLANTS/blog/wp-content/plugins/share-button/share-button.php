...
Copyright 2021 Max Foundry, LLC (https://maxfoundry.com)
*/

namespace MBSocial;

define("MBSOCIAL_ROOT_FILE", __FILE__);
define('MBSOCIAL_VERSION_NUM', '1.17');
define('MBSOCIAL_RELEASE',"10 October 2021");
define('MBSOCIAL_REQUIRED_MB', '8.8.1');
