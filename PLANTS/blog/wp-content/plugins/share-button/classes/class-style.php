	...
	*/
	public function addEffect($css, $effect, $args = array())
	{
		...
		switch($effect)
		{
			...
			/*	$css['mb-label']['hover']['transform'] = 'translateY(0)';
				$css['mb-share-count']['hover']['transform'] = 'translateY(0)';
				$css['mb-icon-wrapper']['hover']['transform'] = 'translateY(0)';
*/
				$hoverCSS = array(
						//				'display' => 'flex',
										'align-items' => 'center',
			...
			break;
			case 'hover';
				/*$color = $css['mb-social']['normal']['background-color'];
				$css = $this->addCSS('background-color', 'darken(' . $color . ', 20%)', 'mb-social', 'hover', $css);
*/
				//$css = $this->addCSS('transition', 'opacity 1.2s linear', 'mb-icon-wrapper', 'normal', $css);
				//$css = $this->addCSS('transition', 'opacity 1.2s linear', 'mb-label', 'hover', $css);
